...
test_iterative = True # en cas de voler la gràfica del recursiu, False
...
def test_aqueducte(n):
    ...
    if test_iterative:
        iterative.calcular_cost_pont(h, alpha, beta, points)
    else:
        recursive.calcular_cost_pont(h, alpha, beta, points)
